      ...
      <div className="w-full max-w-md">
        <div className="rounded-xl border border-[var(--border)] bg-[var(--card-bg)] p-8 shadow-xl">
          <div className="mb-8 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--accent-green)]/20 text-[var(--accent-green)]">
              <UserPlus className="h-6 w-6" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-white">Create account</h1>
              <p className="text-sm text-[var(--foreground)]/70">
                Join Crisis Intelligence System
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[var(--foreground)]/50" />
                <input
                  type="text"
                  value={name}
            ...
            <div>
              ...
              <div className="relative">
                <Globe className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[var(--foreground)]/50" />
                <input
                  type="text"
                  value={country}
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--accent-green)] px-4 py-3 font-medium text-white transition hover:bg-[var(--accent-green)]/90 disabled:opacity-50"
            >
              {loading ? (
